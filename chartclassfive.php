...
WHERE ClassName = 5 GROUP BY StudentName HAVING Tong >=8) AS Tongso";
$res = $db->query($sql);
if ($res->num_rows > 0) {
    $couhsg5 = $res->fetch_assoc();
}
//<!-- ============================================================== -->
$sql = "SELECT COUNT(*) FROM (SELECT class.ClassName,student.StudentName,
AVG(mark.PointCC) ,AVG(mark.PointGK),AVG(mark.PointCK),
...
INNER JOIN handledclass ON student.HID =handledclass.HID 
INNER JOIN class ON handledclass.ClassID=class.ClassID 
WHERE ClassName = 5 GROUP BY StudentName HAVING Tong >=6.5 AND Tong <8) AS Tongso";
$res = $db->query($sql);
if ($res->num_rows > 0) {
    $couhsk5 = $res->fetch_assoc();
}
//<!-- ============================================================== -->
$sql = "SELECT COUNT(*) FROM (SELECT class.ClassName,student.StudentName,
AVG(mark.PointCC) ,AVG(mark.PointGK),AVG(mark.PointCK),
...
INNER JOIN handledclass ON student.HID =handledclass.HID 
INNER JOIN class ON handledclass.ClassID=class.ClassID 
WHERE ClassName = 5 GROUP BY StudentName HAVING Tong >=5 AND Tong <6.5) AS Tongso";
$res = $db->query($sql);
if ($res->num_rows > 0) {
    $couhstb5 = $res->fetch_assoc();
}
//<!-- ============================================================== -->
$sql = "SELECT COUNT(*) FROM (SELECT class.ClassName,student.StudentName,
AVG(mark.PointCC) ,AVG(mark.PointGK),AVG(mark.PointCK),
...
INNER JOIN handledclass ON student.HID =handledclass.HID 
INNER JOIN class ON handledclass.ClassID=class.ClassID 
WHERE ClassName = 5 GROUP BY StudentName HAVING Tong <5) AS Tongso";
$res = $db->query($sql);
if ($res->num_rows > 0) {
    $couhsy5 = $res->fetch_assoc();
}
    ...
    <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-header py-3 bg-transparent">
                ...
                <h5 class="header-title mb-0"> Khối 5 </h5>
            </div>
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        data.addRows([
            ['Học sinh giỏi', <?php echo $couhsg5["COUNT(*)"]; ?>],
            ['Học sinh khá', <?php echo $couhsk5["COUNT(*)"]; ?>],
            ['Học sinh trung bình', <?php echo $couhstb5["COUNT(*)"]; ?>],
            ['Học sinh yếu', <?php echo $couhsy5["COUNT(*)"]; ?>],
        ]);
